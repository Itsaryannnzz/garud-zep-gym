...
def backup():
    ...
    output = "Gym No,Name,Phone,Plan,Join Date,Expiry Date,Cash,Online,Total Paid,Remaining,Status\n"

    for m in members:
        output += f"{m.gym_number},{m.name},{m.phone},{m.plan},{m.join_date},{m.expiry_date},{m.cash_paid},{m.online_paid},{m.paid_amount},{m.remaining_amount},{m.payment_status}\n"
